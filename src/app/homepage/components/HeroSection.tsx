...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full overflow-x-hidden h-auto md:min-h-[clamp(520px,80vh,720px)]">
      {/* Background Image */}
      ...
      {/* Content */}
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-12 h-full flex items-center">
